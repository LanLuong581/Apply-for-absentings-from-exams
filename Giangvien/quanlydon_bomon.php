            ...
            <div class="nav-bar">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container-fluid">
                        ...
                        <form class="d-flex" action="timkiem_bomon.php" method="POST">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                WHERE application.cvgd_status='1' and students.major_id=(SELECT major_id FROM teacher WHERE teacher_id='$teacher_id') ORDER BY application.application_id DESC";
