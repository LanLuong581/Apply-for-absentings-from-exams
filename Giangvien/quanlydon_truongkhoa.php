            ...
            <div class="nav-bar">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="index_TruongKhoa.php" style="font-family: 'Maven Pro', sans-serif;font-size:25px;color:#fff;margin-right:0">
                            <img src="../css/image/bg.png" alt="" width="60" height="60" class="d-inline-block">
                            Hệ Thống Xin Vắng Thi CTU
                        </a>
                        <form class="d-flex" action="timkiem_truongkhoa.php" method="POST">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                WHERE application.bm_status='1' and students.faculty_id=(SELECT faculty_id FROM teacher WHERE teacher_id='$teacher_id') ORDER BY application.application_id DESC";
