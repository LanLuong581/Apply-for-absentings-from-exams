...
if (!isset($_SESSION['acc_account_type'])) {
    ...
    if ($_SESSION['acc_account_type'] != 3) {
        header("location:../templates/login.php");
    }
}
?>
    ...
    <div class="wrapper">
            ...
            <div class="nav-bar">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="index_BoMon.php" style="font-family: 'Maven Pro', sans-serif;font-size:25px;color:#fff;margin-right:0px">
                        ...
                        <div class="box" style="margin-right: 30px;">
                            <div class="home-btn">
                                <a href="index_BoMon.php" style="text-decoration: none;"><button type="button" class="icon-button">
        ...
        <div class="main-content">
            ...
            if (isset($_POST['submit'])) {
                ...
                WHERE application.cvgd_status='1' and students.major_id=(SELECT major_id FROM teacher WHERE teacher_id='$teacher_id') AND students.student_name LIKE '%$search%' ORDER BY application.application_id DESC";
                ...
                ?>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <?php if ($row['bm_status'] == 0) : ?>
                                        <span class="badge bg-warning">Chưa duyệt</span>
                                    <?php elseif ($row['bm_status'] == 1) : ?>
                                        <span class="badge bg-success">Đã duyệt</span>
                                    <?php elseif ($row['bm_status'] == 2) : ?>
                                ...
                                <a class="bi bi-eye" href="indon.php?application_id=<?php echo $row['application_id'] ?>" role="button" style="border:0px;font-size:20px; color:black"></a>
                                    <?php if ($row['bm_status'] == 0) : ?>
                                        <a class="duyet_don" href="bomon_duyet.php?application_id=<?php echo $row['application_id'] ?>"><button type="button" class="bi bi-check-circle" style="border:0px;font-size:20px; color:green"></button></a>
                                        <a class="tu_choi" href="bomon_tuchoi.php?application_id=<?php echo $row['application_id'] ?>"><button type="button" class="bi bi-x-circle" style="border:0px;font-size:20px; color:red"></button></a>
                                    <?php else : ?>
                                    <?php endif; ?>
                                </td>
                            </tr>
            ...
            <a href="quanlydon_bomon.php" style="margin-left: 700px;">Trở lại</a>
        </div>
        <!-- end main-conten -->
        <?php
        //footer
