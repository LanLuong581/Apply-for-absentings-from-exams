...
<body>
    <div class="wrapper">
        ...
        ?>
        <!-- model cập nhật thông tin trưởng khoa-->
        ...
        <!-- end model cập nhật thông tin trưởng khoa -->

        <!-- main-content -->
        <div class="main-content">
            <div class="grid" style="grid-template-columns: repeat(3, 1fr);padding-left:380px">
                <article>
                        ...
                        <div class="modal-content bg-modal">
                            ...
                            <p style="font-size: 20px;">Chào mừng bạn đến hệ thống xin vắng thi của Trường đại học Cần Thơ <br><br>
                                ...
                                <b>Duyệt đơn:</b> Để duyệt đơn bạn thực hiện các bước sau:
                                    ...
                                    <u>Bước 3:</u> Đăng xuất tại góc trên cùng bên phải.
                                    <br>Xin cám ơn
                                </p>
                            </div>
                        </div>
                ...
                <article>
                    ...
                    <div class="text">
                        ...
                        <a href="quanlydon_truongkhoa.php?student_id=<?php echo $_SESSION["acc_student_id"]; ?>"><button>Tiếp</button></a>
            ...
            if (flashdata) {
                Swal.fire(
                    ...
                    if (result.isConfirmed) {
                        location.href = 'index_TruongKhoa.php';
                    }
                })
            }
        </script>
