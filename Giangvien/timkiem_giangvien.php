    ...
    <div class="wrapper">
        ...
        <div class="main-content">
            ...
            if (isset($_POST['submit'])) {
                ...
                $sql = "select application.application_id,application.student_id,students.student_name,major.major_name,application.subject_id,subject.subject_name,application.class_id,semester.semester_name,year.year_name,application.reasons,application.cvgd_status
                    FROM ((((((class
                    ...
                    WHERE class.teacher_id='$teacher_id' and students.student_name LIKE '%$search%' ORDER BY application.application_id DESC";
            ...
            <a href="quanlydon_giangvien.php" style="margin-left: 700px;">Trở lại</a>
        </div>
        <!-- end main-conten -->
        <?php
        //footer
