                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            $sn = 1;
                            $sql = "SELECT teacher_id, teacher_name,teacher_birthday,sex.sex_name,teacher_birthplace,major.major_name,faculty.faculty_name,roles.role_name
                            FROM (((((`teacher` INNER JOIN major ON teacher.major_id=major.major_id)
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row['teacher_birthday'] ?></td>
                                                <td><?php echo $row['sex_name'] ?></td>
                                                ...
                                                <td>
                                                    <a href="edit_canbo.php?teacher_id=<?php echo $row['teacher_id'] ?>"><button type="button" class="bi bi-pencil-square" style="border:0px;font-size:20px"></button></a>
                                                    <a class="delete" href="delete_canbo.php?teacher_id=<?php echo $row['teacher_id'] ?>"><button type="button" class="bi bi-trash" style="border:0px;font-size:20px"></button></a>
...
<?php
    ...
    <script>
        $('.delete').on('click', function(e) {
            ...
            Swal.fire({
                title: 'Bạn có chắc muốn xóa cán bộ này?',
