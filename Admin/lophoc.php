...
<head>
    ...
    <title>Hệ Thống Xin Điểm I - Admin</title>
    <style>
...
<body>
    <div class="wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link btn_canbo " aria-current="page" style="color: #FFFFFF;margin-right:60px" href="index_Admin.php">Cán Bộ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" style=" color: #FFFFFF;margin-right:60px" href="sinhvien.php">Sinh Viên</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" style=" color: #FFFFFF;margin-right:60px" href="lophoc.php">Lớp Học</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" style=" color: #FFFFFF;margin-right:60px" href="quanlydon_admin.php">Đơn Xin</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" id="canbo" role="button" data-bs-toggle="dropdown" aria-expanded="false" style=" color: #FFFFFF;margin-right:60px">
                                    <?php
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li data-bs-toggle="modal" data-bs-target="#ModalThongTincanbo"><a class="dropdown-item bi bi-person"> Thông tin cá nhân</a></li>
        ...
        <div class="modal fade" id="ModalThongTincanbo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
                <div class="modal-content bg-modal">
                    ...
                    <div class="modal-footer">
                        <button type="button" data-bs-toggle="modal" data-bs-target="#update_info_canbo" data-bs-dismiss="modal" class="btn btn-primary update">Cập Nhật</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="update_info_canbo" tabindex="-1" aria-labelledby="updateinfo" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content bg-modal">
                    <div class="modal-header" style="background: #06bee1;">
        ...
        <div class="main-content">
            <div class="lophoc">
                <h4 style="text-align:center">Danh sách môn học</h4>
                <!-- BẢNG MÔN HỌC -->
                <button data-bs-toggle="modal" data-bs-target="#Modalthemmon" type="button" class="btn_them">Thêm Môn Học</button>
                <!-- modal thêm môn học -->
                <div class="modal fade" id="Modalthemmon" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog ">
                        <div class="modal-content bg-modal">
                            <div class="modal-header" style="background: #06bee1;">
                            ...
                            <div class="modal-body">
                                <form class="main-form" action="" method="POST">
                                    <div class="col-md-12">
                                        <div col-md-12>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <label for="subject_id" class="form-label required">Mã Học Phần</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <label for="subject_name" class="form-label required">Tên Học Phần</label>
                                    ...
                                    <div class="modal-footer">
                                        <input type="submit" name="them_mon" id="them_mon" class="btn btn-primary" value="Thêm môn học">
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <!-- end modal thêm môn học -->
                <?php
                $sn = 1;
                $sql_subject = "SELECT * FROM `subject` ORDER BY subject_id ASC";
                $result_subject = mysqli_query($conn, $sql_subject);
                ?>
                        ...
                        if (mysqli_num_rows($result_subject) > 0) {
                            while ($row = mysqli_fetch_assoc($result_subject)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_monhoc.php?subject_id=<?php echo $row['subject_id'] ?>"><button type="button" class="bi bi-pencil-square" style="border:0px;font-size:20px"></button></a>
                                        <a class="delete_subject" href="delete_monhoc.php?subject_id=<?php echo $row['subject_id'] ?>"><button type="button" class="bi bi-trash" style="border:0px;font-size:20px"></button></a>
            ...
            <!-- nút thêm lớp học -->
            <button data-bs-toggle="modal" data-bs-target="#Modalthemlop" type="button" class="btn_them">Thêm Lớp Học</button>
            <!-- Modal Thêm lớp học -->
            <div class="modal fade" id="Modalthemlop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog ">
                    <div class="modal-content bg-modal">
                        <div class="modal-header" style="background: #06bee1;">
                            <h5 class="modal-title" id="exampleModalLabel">Điền Thông Tin Lớp Học</h5>
                        ...
                        <div class="modal-body">
                            <form class="main-form" action="" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <label for="teacher_id" class="form-label required">Cán Bộ Giảng Dạy</label>
                                                            <select name="teacher_id" id="teacher_id" class="form-select" required>
                                                                <?php foreach ($teacher_list as $teacher_ls) : ?>
                                                                    <option value="<?= $teacher_ls['teacher_id'] ?>"><?= $teacher_ls['teacher_id'] ?>-<?= $teacher_ls['teacher_name'] ?></option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                ...
                                <div class="modal-footer">
                                    <input type="submit" name="them_lop" id="them_lop" class="btn btn-primary" value="Thêm lớp">
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            $sn = 1;
            $sql = "SELECT subject.subject_id,subject.subject_name, class.class_id, teacher.teacher_name
                            FROM ((class 
                            INNER JOIN teacher ON class.teacher_id=teacher.teacher_id)
                            INNER JOIN subject on class.subject_id=subject.subject_id) ORDER BY subject.subject_id ASC";
            $result = mysqli_query($conn, $sql);
            ?>
            <table class="table table-striped">
                <thead>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit_class.php?class_id=<?php echo $row['class_id'] ?>"><button type="button" class="bi bi-pencil-square" style="border:0px;font-size:20px"></button></a>
                                    <a class="delete_class" href="delete_class.php?class_id=<?php echo $row['class_id'] ?>"><button type="button" class="bi bi-trash" style="border:0px;font-size:20px"></button></a>
...
if (isset($_POST["them_lop"])) {
    ...
    $sql_them_lop = "INSERT INTO `class`(`class_id`, `subject_id`, `teacher_id`) VALUES ('$class_id','$subject_id','$teacher_id')";
    if (mysqli_query($conn, $sql_them_lop)) {
?>
        <div class="flash-data" data-flashdata=1></div>
        <script>
            const flashdata = $('.flash-data').data('flashdata')
    ...
    ?>
        ...
        <script>
            ...
            if (flashdata) {
                Swal.fire({
                    icon: 'error',
                    title: 'Mã lớp đã bị trùng',
                    text: 'Chưa thêm lớp học, vui lòng kiểm tra lại thông tin'
                })
            }
        </script>
<?php
...
if (isset($_POST["them_mon"])) {
    ...
    $sql_them_mon = "INSERT INTO `subject`(`subject_id`, `subject_name`) VALUES ('$subject_id','$subject_name')";
    if (mysqli_query($conn, $sql_them_mon)) {
?>
        <div class="flash-data" data-flashdata=1></div>
        <script>
            const flashdata = $('.flash-data').data('flashdata')
    ...
    ?>
        ...
        <script>
            ...
            if (flashdata) {
                Swal.fire({
                    icon: 'error',
                    title: 'Mã học phần đã bị trùng',
                    text: 'Chưa thêm học phần, vui lòng kiểm tra lại thông tin'
                })
            }
        </script>
<?php
...
<!-- thông báo xóa học phần -->
<?php if (isset($_GET['b'])) : ?>
    <div class="delete_subject" data-flashdata="<?= $_GET['b']; ?>"></div>
<?php endif; ?>
<script>
    $('.delete_subject').on('click', function(e) {
        ...
        Swal.fire({
            ...
            text: "Việc này đồng nghĩa xóa các lớp của học phần này",
            icon: 'question',
    ...
    const flashdata = $('.delete_subject').data('flashdata')
    if (flashdata) {
        Swal.fire(
            'Đã xóa!',
...
<!-- end thông báo xóa học phần -->

<!-- thông báo xóa lớp -->
<?php if (isset($_GET['a'])) : ?>
    <div class="delete_class" data-flashdata="<?= $_GET['a']; ?>"></div>
<?php endif; ?>
<script>
    $('.delete_class').on('click', function(e) {
        ...
        console.log(self.data('title'));
        Swal.fire({
            title: 'Bạn có chắc muốn xóa lớp học phần này này?',
    ...
    const flashdata = $('.delete_class').data('flashdata')
    if (flashdata) {
        Swal.fire(
            'Đã xóa!',
            'Thông tin đã được xóa.',
