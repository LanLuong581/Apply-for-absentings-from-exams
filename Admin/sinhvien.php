                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            $sn = 1;
                            $sql = "SELECT students.student_id,students.student_name,students.student_birthday,sex.sex_name,
                            students.student_birthplace,students.student_phone,students.student_class_id,course.course_name,academic_year.academicyear_name,
                            major.major_name,faculty.faculty_name
                            FROM ((((( students
                                  INNER JOIN faculty ON faculty.faculty_id=students.faculty_id)
                                  INNER JOIN major ON major.major_id=students.major_id)
                                  INNER JOIN sex ON sex.sex_id=students.sex_id)
                                  INNER JOIN course ON course.course_id=students.course_id)
                                  INNER JOIN academic_year ON academic_year.academicyear_id=students.academicyear_id) ORDER BY students.student_id ASC";
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="delete" href="delete_sinhvien.php?student_id=<?php echo $row['student_id'] ?>"><button type="button" class="bi bi-trash" style="border:0px;font-size:20px"></button></a>
