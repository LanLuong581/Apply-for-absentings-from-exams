            ...
            <div>
                <form class="main-form" action="">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <h3 style="text-align: center;">Danh Sách Điểm Đã Cập Nhật</h3>
                            <?php
                            $student_id = $_SESSION["acc_student_id"];
                            $sn = 1;
                            $sql = "SELECT application.application_id, application.student_id,students.student_name,major.major_name,application.subject_id,subject.subject_name,application.class_id,semester.semester_name,year.year_name,diem.diem_name
                            FROM (((((((diem
                                ...
                                WHERE application.student_id='$student_id' and application.bm_status='1' ORDER BY application.application_id DESC";
